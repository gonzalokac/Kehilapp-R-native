...
import { View, Text, StyleSheet, TouchableOpacity, Dimensions, ScrollView, TextInput, Linking, Alert, Animated } from "react-native";
...
export default function MapaScreen() {
  ...
  // Lugares kosher locales (más lugares agregados)
  const kosherPlaces = [
    {
      id: 1,
      name: "Restaurante Kosher El Recreo",
      address: "Av. Corrientes 1234, CABA",
      rating: 4.5,
      distance: "0.8 km",
      coordinates: { latitude: -34.6027, longitude: -58.3806 },
      description: "Restaurante kosher tradicional con la mejor cocina judía",
    ...
    {
      id: 2,
      name: "Supermercado Kosher Shefa",
      address: "Belgrano 567, CABA",
      rating: 4.2,
      distance: "1.2 km",
      coordinates: { latitude: -34.6047, longitude: -58.3826 },
      description: "Supermercado kosher con productos frescos y secos",
    ...
    {
      id: 3,
      name: "Panadería Kosher Lejem",
      address: "Palermo 890, CABA",
      rating: 4.7,
      distance: "1.5 km",
      coordinates: { latitude: -34.6017, longitude: -58.3836 },
      description: "Panadería artesanal con recetas tradicionales",
      hours: "Lun-Sáb: 6:00-20:00",
    ...
    {
      id: 4,
      name: "Carnicería Kosher Beit HaBasar",
      address: "Once 2345, CABA",
      rating: 4.8,
      distance: "2.1 km",
      coordinates: { latitude: -34.6087, longitude: -58.4056 },
      description: "Carnicería kosher con las mejores carnes certificadas",
      hours: "Lun-Vie: 7:00-19:00, Dom: 8:00-15:00",
    ...
    {
      id: 6,
      name: "Café Kosher Aroma",
      address: "Villa Crespo 4567, CABA",
      rating: 4.3,
      distance: "2.5 km",
      coordinates: { latitude: -34.5967, longitude: -58.4367 },
      description: "Café kosher con ambiente acogedor y pastelería casera",
    ...
    {
      id: 7,
      name: "Tienda Kosher Judaica",
      address: "Palermo 5678, CABA",
      rating: 4.6,
      distance: "1.9 km",
      coordinates: { latitude: -34.5827, longitude: -58.4316 },
      description: "Tienda de artículos judíos y productos kosher importados",
    ...
    {
      id: 8,
      name: "Restaurante Kosher Shalom",
      address: "Belgrano 6789, CABA",
      rating: 4.4,
      distance: "2.3 km",
      coordinates: { latitude: -34.6147, longitude: -58.4026 },
      description: "Restaurante familiar con especialidades de la cocina judía",
  ...
  useEffect(() => {
    ...
    // Inicializar lista filtrada con todos los lugares locales
    setFilteredPlaces(kosherPlaces);
  }, []);
  ...
  // Función para filtrar lugares según búsqueda
  const filterPlaces = (query) => {
    if (!query.trim()) {
      setFilteredPlaces([...kosherPlaces, ...googlePlaces]);
      return;
    }
    
    const allPlaces = [...kosherPlaces, ...googlePlaces];
  ...
  const searchPlacesByText = async (query) => {
    ...
    try {
      ...
      if (data.results && data.results.length > 0) {
        ...
        // Combinar con lugares locales y filtrar
        const allPlaces = [...kosherPlaces, ...googlePlaces, ...places];
        const filtered = allPlaces.filter(place => 
          place.name.toLowerCase().includes(query.toLowerCase()) ||
          place.address.toLowerCase().includes(query.toLowerCase()) ||
          place.type.toLowerCase().includes(query.toLowerCase())
  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      ...
      <LinearGradient colors={["#667eea", "#764ba2"]} style={styles.header}>
        <Text style={styles.headerTitle}>🗺️ Mapa Kosher</Text>
        <Text style={styles.headerSubtitle}>Encuentra lugares kosher cercanos</Text>
      </LinearGradient>
      ...
      <View style={styles.mapContainer}>
        ...
        >
          ...
          {/* Marcadores de todos los lugares kosher */}
          {[...kosherPlaces, ...googlePlaces].map((place) => (
            <Marker
              key={place.id}
        ...
        <View style={styles.floatingSearchContainer}>
          <TextInput
            ...
            placeholder="Buscar lugares kosher..."
        ...
        <View style={styles.modal}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>
              {selectedPlace.image} {selectedPlace.name}
            </Text>
            <Text>{selectedPlace.description}</Text>
            <Text>📍 {selectedPlace.address}</Text>
            {selectedPlace.hours && <Text>⏰ {selectedPlace.hours}</Text>}
            {selectedPlace.phone && <Text>📞 {selectedPlace.phone}</Text>}
            {selectedPlace.rating && <Text>⭐ {selectedPlace.rating}</Text>}
